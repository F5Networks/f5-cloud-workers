...
var configTaskUtil = {
     ...
     */
    sendPatchToBoundState : function(configTaskState, referrer) {

        var op = this.createPatchOperation(configTaskState.selfLink, referrer).setBody({
     ...
     * @param referrer referrer uri string
     */
    sendPatchToUnBoundState : function(configTaskState, referrer) {
        var op = this.createPatchOperation(configTaskState.selfLink, referrer).setBody({
            "subStatus": "UPDATE_BLOCK_WITH_RESPONSE",
            "block": {
     ...
     * @param referrer referrer uri string
     */
    sendPatchToErrorState : function(configTaskState, err, referrer) {
        var op = this.createPatchOperation(configTaskState.selfLink, referrer).setBody({
            "subStatus": "UPDATE_BLOCK_WITH_RESPONSE",
            "block": {
     ...
     * @return {*}
     */
    createPatchOperation : function(selfLink, referrer) {
        ...
        var localBlockConfigTaskUri = this.restHelper.makeRestjavadUri(blockConfigTaskUriPathname, null, false);
